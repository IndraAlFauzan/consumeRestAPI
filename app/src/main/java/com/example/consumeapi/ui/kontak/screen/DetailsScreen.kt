...
import com.example.consumeapi.ui.kontak.viewmodel.DetaiksKontakUiState
...
fun DetailStatus(
    ...
    when (kontakUIState) {
        is DetaiksKontakUiState.Success -> {
        ...
        is DetaiksKontakUiState.Loading -> {
            OnLoading(modifier = modifier)
        }

        is DetaiksKontakUiState.Error -> {
